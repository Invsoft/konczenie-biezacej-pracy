...
export const GodzinaZakonczenia = ({ params, callbacks }) => {
    ...
    return (
        ...
        <div className={classNames(
            ...
            <TimePicker bordered={false} format={FORMAT_KONTROLEK_CZASU} placeholder='zakończenie'
            ...
            <TimePicker bordered={false} format={FORMAT_KONTROLEK_CZASU} showNow={false} suffixIcon={null} allowClear={false} placeholder='godz:min'
